...
const speaker = [
  {
    ...
    speakerTitle: 'Space X founder and Paypal',
  ...
  },
  {
    ...
    speakerName: 'markzuckerberg',
    speakerTitle: 'Face book CEO',
    sDetail: 'mark is the founder of facebook. he aslo created meta. he has played an important role in connecting the world',
  },
  {
    ...
    speakerName: 'Jeff Bezos',
    speakerTitle: 'Amazon CEO',
    sDetail: 'the founder  of tesla and space X . who invented elecetric vehicles and the first person to create reusable space craft',
  },
  {
    speakerImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRriiOkMsGax7txnLXH370xfbVkfhJDgQxaZg&usqp=CAU',
